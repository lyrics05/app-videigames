...
export function getVideoGames() {
    return function(dispatch) {
     axios.get("https://app-videigames.onrender.com/videogames")
    .then((response) => {
...
export function getGamesById (id){
    ...
    return async function(dispatch){
        var json = await axios.get(`https://app-videigames.onrender.com/videogames/${id}`);
    return dispatch( {
...
export function getGameByName(name) {
    return async function(dispatch) {
         ...
         await axios.get(`https://app-videigames.onrender.com/videogames?name=${name}`).then(res=>{
...
export function crearGame(payload){
    return async function(dispatch){
     try {
        var response = await axios.post("https://app-videigames.onrender.com/videogame",payload)
        alert("CREADO")
        return response
     } catch (error) {
       alert(error) 
...
export function getGenres (){
    ...
    return async function(dispatch){
        var json = await axios.get(`https://app-videigames.onrender.com/genres`);
